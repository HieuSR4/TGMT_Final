  ...
  return (
    <>
      ...
      <div className="p-5 w-85">
        ...
        {/* song squares */}
        <h2 className="mt-5 mb-3">Xin chào <span className="text-primary" id="username">{username}</span></h2>
        ...
        {/* webcam and list */}
        <h2 className="mt-5">Âm nhạc dựa trên cảm xúc</h2>
        <div className="d-flex justify-content-between mt-3 w-100">
          ...
          <div id="cam-div">
            ...
            <button onClick={() => fetchMusic()}>Nhận diện và đề xuất âm nhạc</button>
          </div>
